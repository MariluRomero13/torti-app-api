...
Route.get('/assignment-customers-page/:page?','AssignmentCustomerController.index')
  .as('assignment-customers.pagination')
Route.get('assignment-customers','AssignmentCustomerController.create')
  .as('assignment-customers.create')
